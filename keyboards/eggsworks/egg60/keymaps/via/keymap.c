...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MACOS] = LAYOUT(
        ...
        KC_CAPS, KC_A,    KC_S,    KC_D,            KC_F,    KC_G,                                  KC_H,           KC_J,           KC_K,           KC_L,       KC_SCLN,    KC_DEL, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,            KC_V,    KC_B,                                  KC_N,           KC_M,           KC_COMM,        KC_DOT,     KC_SLSH,    KC_RSFT, \
        KC_LGUI, KC_LCTL, KC_LALT, KC_SPC,          MO(_FN),            KC_BACKSPACE,   TO(_BASE),                  KC_ENT,         KC_SPC,         KC_LBRC,    KC_RBRC,    KC_BSLS
    ),
    [_FN] = LAYOUT(
        KC_GRV,     KC_F1,   KC_F2,   KC_F3,        KC_F4,   KC_F5,                                 KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11, \
        KC_TRNS,    KC_TRNS, KC_PGUP, KC_UP,        KC_PGDN, KC_VOLU,                               KC_QUOT,        KC_LCBR,        KC_EXLM,        KC_RCBR,        KC_UNDS,        KC_F12, \
        KC_TRNS,    KC_TRNS, KC_LEFT, KC_DOWN,      KC_RGHT, KC_VOLD,                               LSFT(KC_QUOT),  KC_LPRN,        KC_AMPR,        KC_RPRN,        C(G(S(KC_4))),  KC_PPLS, \
        KC_TRNS,    KC_TRNS, KC_HOME, KC_TRNS,      KC_END,  KC_MUTE,                               LSFT(KC_MINS),  KC_LBRC,        KC_PIPE,        KC_RBRC,        C(S(KC_5)),     KC_TRNS, \
        KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS,      KC_TRNS,        KC_TRNS,        KC_TRNS,                        KC_PMNS,        KC_LEFT,        KC_UP,          KC_DOWN,        KC_RGHT
    )
};
...
static inline void scroll(const int8_t keycode) {
...
report_mouse_t pointing_device_task_user(report_mouse_t mouse_report) {
    if (layer >= _FN) {
        ...
        if (mouse_report.h || mouse_report.v) {
            ...
            // scroll_ticks = (scroll_ticks + 1) % (SCROLL_WAIT_PERIOD + 300);
            // scroll_ticks = (scroll_ticks + 500) % SCROLL_WAIT_PERIOD;
        }
